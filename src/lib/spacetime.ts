...
const SUBSCRIPTION_VIEW_REFRESH_SCOPES: Record<string, string[]> = {
  ...
  my_wallet_balance: ['wallet'],
  my_wallet_transactions: ['wallet'],
...
const SUBSCRIPTION_VIEW_TABLE_KEYS: Record<string, string[]> = {
  ...
  my_wallet_balance: ['myWalletBalance', 'my_wallet_balance'],
  my_wallet_transactions: ['myWalletTransactions', 'my_wallet_transactions'],
